...
import OBSIDIAN.VolcanoRenderer.shaders.ShaderProgram;
import OBSIDIAN.VolcanoRenderer.utils.Textures.Texture;
...
public class GUIRender {
    ...
    public GUIRender(Window window) {
        ...
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("assets/shaders/gui.vert", GL_VERTEX_SHADER));
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("assets/shaders/gui.frag", GL_FRAGMENT_SHADER));
    ...
    public void render(Scene scene) {
        GUInterface guiInstance = scene.getGuiInstance();
        if (guiInstance == null) {
            return;
        }
        guiInstance.drawGui();
